...
public class AddElementsToArray {
    ...
    public static void main(String[] args) {
        ...
        int[] arr = {1,2,3,4};
        arr = addInteger(arr, 5); // it is returning me a new array
        ...
        String[] names = {"Tatiana", "Oleksandra","Cassandra","Piyade"}; // last element "Ali" olsun
        names = addString(names,"Ali");
...
//3. create a return method called addString that can add a String after the last index of a String array
 public static String[] addString(String[] array, String element){ // //kisayol tum double lari Stringe cevirmek icin: command+r
