...
public class ScrumTeam {
    ...
    public ArrayList<Tester> testersList = new ArrayList<>(); // Scrum team de birkac tane developer ve tester oldugu icin Array list olarak declare ediyoruz
    ...
    public void removeTester(int employeeID){
        testersList.removeIf( p-> p.employeeID == employeeID );//verilen employeeID testerlisttekiyle uyusunca onu cikartiyoruz o listeden
    }
